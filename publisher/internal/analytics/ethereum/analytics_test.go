...
var knownTokens = map[string]TokenTransaction{
	"WETH":  {Token: repository.Token{Symbol: "WETH", Decimals: 18}},
	"WBTC":  {Token: repository.Token{Symbol: "WBTC", Decimals: 8}},   // WBTC / WETH
	"MATIC": {Token: repository.Token{Symbol: "MATIC", Decimals: 18}}, // MATIC / WETH
	"USDC":  {Token: repository.Token{Symbol: "USDC", Decimals: 6}},   // USDC / WETH
	"USDT":  {Token: repository.Token{Symbol: "USDT", Decimals: 6}},   // WETH / USDT
}
